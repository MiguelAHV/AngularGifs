// To parse this data:
//
//   import { Convert, InterfaceGifs } from "./file";
//
//   const interfaceGifs = Convert.toInterfaceGifs(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface InterfaceGifs {
    data:       Datum[];
...
export class Convert {
    public static toInterfaceGifs(json: string): InterfaceGifs {
        return cast(JSON.parse(json), r("InterfaceGifs"));
    }

    public static interfaceGifsToJson(value: InterfaceGifs): string {
        return JSON.stringify(uncast(value, r("InterfaceGifs")), null, 2);
    }
}
